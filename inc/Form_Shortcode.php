...
add_action( 'wp_enqueue_scripts', 'stoff_form_scripts_recaptcha' );
function stoff_form_scripts_recaptcha() {
    wp_enqueue_style( 'stoff-form-style', 'https://maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css', array(), '1.0', 'all' );
}
                                ...
                                <fieldset class="w-534">
                                    ...
                                    <div class="form-card">
                                        <div id="step-one-fields">
                                            ...
                                            <!-- <div class="g-recaptcha" data-sitekey="6LdlkKEpAAAAABp1D-1UZcgm_iOyQM8KC0_Pkqn0"></div> -->
                                ...
                                <fieldset class="w-787">
                                    ...
                                    <div id="step-two-fields">
                                        ...
                                        <div class="approx d-grid item-center gap-30 ss-gic mt-50">
                                            <label for="approx" class="label-text">How many <span
                                                    class="sm-bold">yards</span>
                                                do you
                                                approx.
                                                need?</label>
                                            <input type="number" class="gsm-field" placeholder="0000" name="approx"
                                                id="approx">
                                        </div>
                                    ...
                                    <div id="step-three-fields">
                                        ...
                                        <div class="upload-file d-grid gap-76 item-top ts-gic mt-50">
                                            ...
                                            <div class="upload-file-div">
                                                ...
                                                <div class="image-show">Design Uploaded!</div>
                                            </div>
                                        ...
                                        <div class="anything-else d-grid gap-76 item-top ts-gic mt-120">
                                            <label for="anything-else" class="label-text">Anything else we should
                                                know?</label>
                                        ...
                                        <!-- Captcha? -->
                                        <div class="anything-else d-grid gap-76 item-top ts-gic mt-120">
                                            <label for="anything-else" class="label-text captcha-label">Are you
                                                human?</label>
...
function stoff_thankyou_page() {
    ...
    <fieldset class="finish-step">
        ...
        <div class="thank-you-button-div">
            <!-- Next Button -->
            <a href="/#msform" id="thank-you-button" class="">Create New
                Auction</a>
        </div>
    </fieldset>
